...
Wavelength and frequency have an inverse relationship — as frequency increases, wavelength gets shorter. More cycles per second means each cycle takes up less physical space. The formula for converting frequency to wavelength is simple: wavelength in meters equals 300 divided by frequency in megahertz — or written as a formula: λ(m) = 300 / f(MHz). This is one of the most important formulas to know.
